...
@push('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const processButton = document.getElementById('process-checkout');

            if (checkoutForm && processButton) {
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                            ...
                            <div class="space-y-4">
                                <!-- Credit/Debit Card -->
                                <label
                                    class="flex items-center p-4 border border-gray-300 rounded-lg hover:border-blue-500 cursor-pointer">
                                ...
                                <label
                                    ...
                                    <div class="ml-auto">
                                        <div class="w-10 h-6 bg-blue-100 rounded"></div>
                                    </div>
                                </label>
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 sticky top-24">
                            ...
                            <div class="border-t border-gray-200 pt-4 mb-6">
                                ...
                                <p class="text-sm text-gray-500 mt-1">Including all taxes</p>
                            </div>
                                ...
                                <label class="flex items-start space-x-2">
                                    ...
                                    <span class="text-sm text-gray-600">
                                        I agree to the <a href="{{ route('terms') }}"
                                            class="text-blue-600 hover:text-blue-700">Terms and Conditions</a>
                                        and <a href="{{ route('privacy') }}"
                                            class="text-blue-600 hover:text-blue-700">Privacy Policy</a>
                                    </span>
                                </label>
                            </div>

                            <!-- Place Order Button -->
                            <button id="process-checkout" type="submit"
                            ...
                            <div class="mt-6 text-center">
                                <p class="text-sm text-gray-600">Need help? <a href="{{ route('contact') }}"
                                        class="text-blue-600 hover:text-blue-700">Contact us</a></p>
                            </div>
                        </div>
                    </div>
                </div>
